...
def register_mealplan_tools(mcp: FastMCP, mealie: MealieFetcher) -> None:
    ...
    async def get_all_mealplans(
        ...
        try:
            ...
            return await mealie.get_mealplans(
                start_date=start_date,
                end_date=end_date,
                page=page,
                per_page=per_page,
    ...
    async def create_mealplan(
        ...
        try:
            ...
            return await mealie.create_mealplan(
                date=date,
                recipe_id=recipe_id,
                title=title,
                entry_type=entry_type,
    ...
    @mcp.tool()
    async def create_mealplan_bulk(
        ...
        try:
            ...
            for entry in entries:
                ...
                await mealie.create_mealplan(**entry_obj.model_dump())
    ...
    @mcp.tool()
    async def get_todays_mealplan() -> List[Dict[str, Any]]:
        ...
        try:
            ...
            return await mealie.get_todays_mealplan()
        except Exception as e:
